	...
	<br><br>
		...
		<table border="1" align="center">
				...
				<c:otherwise>
					<c:forEach items="${list}" var="dto">
						<tr>
							<td>${dto.noticeSeq }</td>
							<td>
								<a href="noticeanswer.do?command=detail&noticeSeq=${dto.noticeSeq }">${dto.title }</a>
							</td>
							<td>${dto.regId }</td>
							<td>${dto.regDt }</td>
							<td>${dto.modDt }</td>
			...
			<tr>
				...
				<input type="button" value="글쓰기" onclick="location.href='noticeanswer.do?command=writeform'">
				</td>
			</tr>
			</table>
